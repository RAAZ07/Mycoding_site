...
def submission(request, problem_id):
    ...
    if request.method == "POST":
        ...
        subprocess.run(['docker', 'cp', f'codes/{user.id}_{problem_id}.cpp', '55d0f281f07402ceb40866aabdc90420a149c3d42748be5383cb5ff4854c3d2f:/a.cpp'], shell=True,
                       capture_output=True)
        output = subprocess.run(['docker', 'exec', '55d0f281f07402ceb40866aabdc90420a149c3d42748be5383cb5ff4854c3d2f', 'g++', 'a.cpp'], shell=True,
        ...
        if output.returncode == 0:
            out = subprocess.run(['docker', 'exec', '-i', '55d0f281f07402ceb40866aabdc90420a149c3d42748be5383cb5ff4854c3d2f', './a.out'], shell=True, capture_output=True,
                                 text=True, input=input_text)
            print(out)
            subprocess.run(['docker', 'exec', '55d0f281f07402ceb40866aabdc90420a149c3d42748be5383cb5ff4854c3d2f', 'rm', '-rf', 'a.out'], shell=True)
            subprocess.run(['docker', 'exec', '55d0f281f07402ceb40866aabdc90420a149c3d42748be5383cb5ff4854c3d2f', 'rm', '-rf', 'a.cpp'], shell=True)
